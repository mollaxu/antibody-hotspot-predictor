            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 8:
                        ...
                        if (!getRCSBAssemblySymmetryConfig(this.plugin).ApplyColors) return [3 /*break*/, 10];
...
var EnableAssemblySymmetry3D = StateAction.build({
    ...
    return Task.create('Enable Assembly Symmetry', function (ctx) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    presetParams = (_a = AssemblySymmetryPreset.params) === null || _a === void 0 ? void 0 : _a.call(AssemblySymmetryPreset, a, plugin);
                    presetProps = presetParams ? PD.getDefaultValues(presetParams) : Object.create(null);
                    return [4 /*yield*/, AssemblySymmetryPreset.apply(ref, presetProps, plugin)];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
