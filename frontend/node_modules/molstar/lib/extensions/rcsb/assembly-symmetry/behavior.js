        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, AssemblySymmetryDataProvider.attach(propCtx, a.data, params)];
                case 1:
                    _a.sent();
                    ...
                    return [4 /*yield*/, AssemblySymmetryProvider.attach(propCtx, a.data, __assign(__assign({}, params), { symmetryIndex: symmetryIndex }))];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
...
export var AssemblySymmetryPreset = StructureRepresentationPresetProvider({
    ...
    params: function (a, plugin) {
        return __assign(__assign({}, StructureRepresentationPresetProvider.CommonParams), getConfiguredDefaultParams(plugin));
    },
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, AssemblySymmetryDataProvider.attach(propCtx, structure, propProps)];
                                        case 1:
                                            _a.sent();
                                            assemblySymmetryData = AssemblySymmetryDataProvider.get(structure).value;
                                            symmetryIndex = assemblySymmetryData ? AssemblySymmetry.firstNonC1(assemblySymmetryData) : -1;
                                            return [4 /*yield*/, AssemblySymmetryProvider.attach(propCtx, structure, __assign(__assign({}, propProps), { symmetryIndex: symmetryIndex }))];
                                        case 2:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
...
//
export var RCSBAssemblySymmetryConfig = {
...
export function getRCSBAssemblySymmetryConfig(plugin) {
    var _a, _b, _c, _d, _e, _f;
    return {
        ApplyColors: (_b = (_a = plugin.config.get(RCSBAssemblySymmetryConfig.ApplyColors)) !== null && _a !== void 0 ? _a : RCSBAssemblySymmetryConfig.ApplyColors.defaultValue) !== null && _b !== void 0 ? _b : true,
        DefaultServerType: (_d = (_c = plugin.config.get(RCSBAssemblySymmetryConfig.DefaultServerType)) !== null && _c !== void 0 ? _c : RCSBAssemblySymmetryConfig.DefaultServerType.defaultValue) !== null && _d !== void 0 ? _d : AssemblySymmetryDataParams.serverType.defaultValue,
        DefaultServerUrl: (_f = (_e = plugin.config.get(RCSBAssemblySymmetryConfig.DefaultServerUrl)) !== null && _e !== void 0 ? _e : RCSBAssemblySymmetryConfig.DefaultServerUrl.defaultValue) !== null && _f !== void 0 ? _f : AssemblySymmetryDataParams.serverUrl.defaultValue,
    };
}
function getConfiguredDefaultParams(plugin) {
    var config = getRCSBAssemblySymmetryConfig(plugin);
    var params = PD.clone(AssemblySymmetryDataParams);
