...
var _Base = /** @class */ (function () {
    function _Base(_root, _node) {
        this._root = _root;
        this._node = _node;
    }
    /** Create a new node, append as child to current _node, and return the new node */
    _Base.prototype.addChild = function (kind, params) {
        var _a;
        var _b;
        var allowedParamNames = Object.keys(MVSTreeSchema.nodes[kind].params);
        var node = {
            kind: kind,
...
var Root = /** @class */ (function (_super) {
    ...
    function Root() {
        var _this = this;
        var node = { kind: 'root' };
        _this = _super.call(this, undefined, node) || this;
        _this._root = _this;
        return _this;
    }
    /** Return the current state of the builder as object in MVS format. */
    Root.prototype.getState = function (metadata) {
        return {
            root: deepClone(this._node),
            metadata: __assign(__assign({}, metadata), { version: "".concat(MVSData.SupportedVersion), timestamp: utcNowISO() }),
        };
    };
    ...
    Root.prototype.download = function (params) {
...
var Download = /** @class */ (function (_super) {
    ...
    Download.prototype.parse = function (params) {
...
var Parse = /** @class */ (function (_super) {
    ...
    Parse.prototype.modelStructure = function (params) {
        if (params === void 0) { params = {}; }
        return new Structure(this._root, this.addChild('structure', __assign({ type: 'model' }, pickObjectKeys(params, StructureParamsSubsets.model))));
    };
     ...
     * Return builder pointing to the new node. */
    Parse.prototype.assemblyStructure = function (params) {
        if (params === void 0) { params = {}; }
        return new Structure(this._root, this.addChild('structure', __assign({ type: 'assembly' }, pickObjectKeys(params, StructureParamsSubsets.assembly))));
    };
     ...
     * Return builder pointing to the new node. */
    Parse.prototype.symmetryStructure = function (params) {
        if (params === void 0) { params = {}; }
        return new Structure(this._root, this.addChild('structure', __assign({ type: 'symmetry' }, pickObjectKeys(params, StructureParamsSubsets.symmetry))));
    };
     ...
     * Return builder pointing to the new node. */
    Parse.prototype.symmetryMatesStructure = function (params) {
        if (params === void 0) { params = {}; }
        return new Structure(this._root, this.addChild('structure', __assign({ type: 'symmetry_mates' }, pickObjectKeys(params, StructureParamsSubsets.symmetry_mates))));
    };
    return Parse;
}(_Base));
export { Parse };
...
var Structure = /** @class */ (function (_super) {
    ...
    Structure.prototype.component = function (params) {
        var _a;
        if (params === void 0) { params = {}; }
        var fullParams = __assign(__assign({}, params), { selector: (_a = params.selector) !== null && _a !== void 0 ? _a : MVSDefaults.component.selector });
    ...
    Structure.prototype.componentFromUri = function (params) {
    ...
    Structure.prototype.componentFromSource = function (params) {
    ...
    Structure.prototype.labelFromUri = function (params) {
    ...
    Structure.prototype.labelFromSource = function (params) {
    ...
    Structure.prototype.tooltipFromUri = function (params) {
    ...
    Structure.prototype.tooltipFromSource = function (params) {
    ...
    Structure.prototype.transform = function (params) {
        if (params === void 0) { params = {}; }
...
var Component = /** @class */ (function (_super) {
    ...
    Component.prototype.representation = function (params) {
        var _a;
        if (params === void 0) { params = {}; }
        var fullParams = __assign(__assign({}, params), { type: (_a = params.type) !== null && _a !== void 0 ? _a : 'cartoon' });
    ...
    Component.prototype.label = function (params) {
    ...
    Component.prototype.tooltip = function (params) {
    ...
    Component.prototype.focus = function (params) {
        if (params === void 0) { params = {}; }
...
var Representation = /** @class */ (function (_super) {
    ...
    Representation.prototype.color = function (params) {
    ...
    Representation.prototype.colorFromUri = function (params) {
    ...
    Representation.prototype.colorFromSource = function (params) {
...
export function builderDemo() {
    var builder = createMVSBuilder();
    builder.canvas({ background_color: 'white' });
    var struct = builder.download({ url: 'https://www.ebi.ac.uk/pdbe/entry-files/download/1og2_updated.cif' }).parse({ format: 'mmcif' }).modelStructure();
    ...
    var cif = builder.download({ url: 'https://www.ebi.ac.uk/pdbe/entry-files/download/1wrf_updated.cif' }).parse({ format: 'mmcif' });
