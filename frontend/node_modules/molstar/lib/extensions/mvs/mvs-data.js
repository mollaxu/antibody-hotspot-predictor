...
export var MVSData = {
    ...
    fromMVSJ: function (mvsjString) {
        ...
        if (major === undefined) {
            ...
            console.warn("Loaded MVS is of higher version (".concat(result.metadata.version, ") than currently supported version (").concat(MVSData.SupportedVersion, "). Some features may not work as expected."));
        }
        return result;
    },
