...
export function setCamera(plugin, params) {
    return __awaiter(this, void 0, void 0, function () {
        var target, position, up, snapshot;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    target = Vec3.create.apply(Vec3, params.target);
                    position = Vec3.create.apply(Vec3, params.position);
                    if (plugin.canvas3d)
                        position = fovAdjustedPosition(target, position, plugin.canvas3d.camera.state.mode, plugin.canvas3d.camera.state.fov);
                    up = Vec3.create.apply(Vec3, params.up);
                    ...
                    return [4 /*yield*/, PluginCommands.Camera.SetSnapshot(plugin, { snapshot: snapshot })];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
export function setFocus(plugin, structureNodeSelector, params) {
    var _a;
    if (params === void 0) { params = MVSDefaults.focus; }
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    boundingSphere = structure ? Loci.getBoundingSphere(Structure.Loci(structure)) : getPluginBoundingSphere(plugin);
                    ...
                    direction = Vec3.create.apply(Vec3, params.direction);
                    up = Vec3.create.apply(Vec3, params.up);
...
function snapshotFromSphereAndDirections(camera, options) {
    ...
    var deltaDirection = Vec3.setMagnitude(_tmpVec, direction, distance);
    var position = Vec3.sub(Vec3(), center, deltaDirection);
...
function fovAdjustedPosition(target, refPosition, mode, fov) {
    var delta = Vec3.sub(Vec3(), refPosition, target);
...
function getRenderObjects(plugin, includeHidden) {
    var reprCells = Array.from(plugin.state.data.cells.values()).filter(function (cell) { return cell.obj && PluginStateObject.isRepresentation3D(cell.obj); });
    if (!includeHidden)
...
export function setCanvas(plugin, params) {
    var _a, _b, _c;
    var backgroundColor = (_a = decodeColor(params === null || params === void 0 ? void 0 : params.background_color)) !== null && _a !== void 0 ? _a : DefaultCanvasBackgroundColor;
    if (backgroundColor !== ((_b = plugin.canvas3d) === null || _b === void 0 ? void 0 : _b.props.renderer.backgroundColor)) {
        (_c = plugin.canvas3d) === null || _c === void 0 ? void 0 : _c.setProps(function (old) { return (__assign(__assign({}, old), { renderer: __assign(__assign({}, old.renderer), { backgroundColor: backgroundColor }) })); });
    }
}
