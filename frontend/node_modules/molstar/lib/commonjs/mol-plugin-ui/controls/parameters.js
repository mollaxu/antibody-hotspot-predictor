...
function ToggleParamHelpButton(_a) {
    var show = _a.show, toggle = _a.toggle, title = _a.title;
    return (0, jsx_runtime_1.jsx)("button", { className: 'msp-help msp-btn-link msp-btn-icon msp-control-group-expander', onClick: toggle, title: title || "".concat(show ? 'Hide' : 'Show', " help"), style: { background: 'transparent', textAlign: 'left', padding: '0' }, children: (0, jsx_runtime_1.jsx)(icons_1.Icon, { svg: icons_1.HelpOutlineSvg }) });
}
