...
var CombinedColorControl = /** @class */ (function (_super) {
    ...
    CombinedColorControl.prototype.swatch = function () {
        var _this = this;
        return (0, jsx_runtime_1.jsx)("div", { className: 'msp-combined-color-swatch', children: swatches_1.DefaultColorSwatch.map(function (c) { return (0, jsx_runtime_1.jsx)(common_1.Button, { inline: true, "data-color": c[1], onClick: _this.onClickSwatch, style: { background: color_1.Color.toStyle(c[1]) } }, c[1]); }) });
    };
...
function ColorOptions() {
    ...
    _colors = (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: swatches_1.DefaultColorSwatch.map(function (v) {
            return (0, jsx_runtime_1.jsx)("option", { value: v[1], style: { background: "".concat(color_1.Color.toStyle(v[1])) }, children: (0, string_1.stringToWords)(v[0]) }, v[1]);
        }) });
    return _colors;
}
...
function ColorValueOption(color) {
    return !DefaultColorSwatchMap.has(color) ? (0, jsx_runtime_1.jsx)("option", { value: color, style: { background: "".concat(color_1.Color.toStyle(color)) }, children: color_1.Color.toRgbString(color) }, color_1.Color.toHexString(color)) : null;
}
