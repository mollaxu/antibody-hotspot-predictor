...
var ComponentListControls = /** @class */ (function (_super) {
    ...
    ComponentListControls.prototype.render = function () {
        ...
        if (componentGroups.length === 0)
            return null;
        return (0, jsx_runtime_1.jsx)("div", { style: { marginTop: '6px' }, children: componentGroups.map(function (g) { return (0, jsx_runtime_1.jsx)(StructureComponentGroup, { group: g }, g[0].cell.transform.ref); }) });
    };
