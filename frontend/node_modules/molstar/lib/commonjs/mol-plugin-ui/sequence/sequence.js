...
var Sequence = /** @class */ (function (_super) {
    ...
    Sequence.prototype.residue = function (seqIdx, label, marker) {
        return (0, jsx_runtime_1.jsx)("span", { "data-seqid": seqIdx, style: { backgroundColor: this.getBackgroundColor(marker) }, className: this.getResidueClass(seqIdx, label), children: "\u200B".concat(label, "\u200B") }, seqIdx);
    };
    ...
    Sequence.prototype.getSequenceNumberSpan = function (seqIdx, label) {
        ...
        return (0, jsx_runtime_1.jsx)("span", { className: this.getSequenceNumberClass(seqIdx, seqNum, label), children: this.padSeqNum(seqNum) }, "marker-".concat(seqIdx));
    };
