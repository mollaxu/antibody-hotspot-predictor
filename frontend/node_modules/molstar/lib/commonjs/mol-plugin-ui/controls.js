...
function ViewportSnapshotDescription() {
    var _a;
    var plugin = React.useContext(base_1.PluginReactContext);
    var _b = React.useState(0), _ = _b[0], setV = _b[1];
    React.useEffect(function () {
        var sub = plugin.managers.snapshot.events.changed.subscribe(function () { return setV(function (v) { return v + 1; }); });
        return function () { return sub.unsubscribe(); };
    }, [plugin]);
    var current = plugin.managers.snapshot.state.current;
    if (!current)
        return null;
    var e = plugin.managers.snapshot.getEntry(current);
...
function MarkdownAnchor(_a) {
    var href = _a.href, children = _a.children, element = _a.element;
    var plugin = React.useContext(base_1.PluginReactContext);
    if (!href)
        return element;
    if (href[0] === '#') {
        return (0, jsx_runtime_1.jsx)("a", { href: '#', onClick: function (e) {
                e.preventDefault();
