...
function Snapshots(ctx) {
    ...
    commands_1.PluginCommands.State.Snapshots.Add.subscribe(ctx, function (_a) {
        var key = _a.key, name = _a.name, description = _a.description, params = _a.params;
        return tslib_1.__awaiter(_this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        image = _b;
                        entry = snapshots_1.PluginStateSnapshotManager.Entry(snapshot, { key: key, name: name, description: description, image: image });
