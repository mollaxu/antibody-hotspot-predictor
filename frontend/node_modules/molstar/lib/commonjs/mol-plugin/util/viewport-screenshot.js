...
var ViewportScreenshotHelper = /** @class */ (function (_super) {
    ...
    ViewportScreenshotHelper.prototype.createPass = function (multisample) {
        ...
        return c.getImagePass({
            ...
            multiSample: tslib_1.__assign(tslib_1.__assign({}, c.props.multiSample), { mode: multisample ? 'on' : 'off', sampleLevel: colorBufferFloat && textureFloat ? 4 : 2 }),
