...
var json_1 = require("../../../mol-util/json");
var object_1 = require("../../../mol-util/object");
var param_choice_1 = require("../../../mol-util/param-choice");
var param_definition_1 = require("../../../mol-util/param-definition");
var atom_ranges_1 = require("../helpers/atom-ranges");
var indexing_1 = require("../helpers/indexing");
var param_definition_2 = require("../helpers/param-definition");
...
var MVSAnnotationFormat = new param_choice_1.Choice({ json: 'json', cif: 'cif', bcif: 'bcif' }, 'json');
...
exports.MVSAnnotationsProvider = custom_model_property_1.CustomModelProperty.createProvider({
    ...
    getParams: function (data) { return exports.MVSAnnotationsParams; },
    ...
    obtain: function (ctx, data, props) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    props = tslib_1.__assign(tslib_1.__assign({}, param_definition_1.ParamDefinition.getDefaultValues(exports.MVSAnnotationsParams)), props);
...
function getMVSAnnotationForStructure(structure, annotationId) {
    ...
    for (var _i = 0, models_1 = models; _i < models_1.length; _i++) {
        ...
        if (model.customProperties.has(exports.MVSAnnotationsProvider.descriptor)) {
            var annots = exports.MVSAnnotationsProvider.get(model).value;
...
var MVSAnnotation = /** @class */ (function () {
    ...
    MVSAnnotation.prototype.getRowForEachAtom = function (model) {
        var indices = indexing_1.IndicesAndSortings.get(model);
        var nAtoms = model.atomicHierarchy.atoms._rowCount;
        var result = Array(nAtoms).fill(-1);
        var rows = this.getRows();
        var _loop_1 = function (i, nRows) {
            var atomRanges = (0, selections_1.getAtomRangesForRow)(model, rows[i], indices);
            atom_ranges_1.AtomRanges.foreach(atomRanges, function (from, to) { return result.fill(i, from, to); });
        };
...
function getRowsFromJson(data, schema) {
    var js = data;
    var cifSchema = (0, schemas_1.getCifAnnotationSchema)(schema);
    if (Array.isArray(js)) {
        // array of objects
        return js.map(function (row) { return (0, object_1.pickObjectKeys)(row, Object.keys(cifSchema)); });
    }
    else {
        // object of arrays
        var rows = [];
...
function getRowsFromCif(data, schema) {
    var rows = [];
    var cifSchema = (0, schemas_1.getCifAnnotationSchema)(schema);
    var table = (0, schema_1.toTable)(cifSchema, data);
...
function getRowsFromTable(table) {
    ...
    var Present = db_1.Column.ValueKind.Present;
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    url = assets_1.Asset.getUrlAsset(ctx.assetManager, source.url);
                ...
                case 5: return [4 /*yield*/, cif_1.CIF.parse(rawData).run()];
                case 6:
                    parsed = _c.sent();
                    if (parsed.isError)
            ...
            switch (_b.label) {
                case 0:
                    ...
                    for (_i = 0, sources_1 = sources; _i < sources_1.length; _i++) {
                        src = sources_1[_i];
                        key = (0, json_1.canonicalJsonString)(src);
                        (_a = promises[key]) !== null && _a !== void 0 ? _a : (promises[key] = (0, utils_1.safePromise)(getFileFromSource(ctx, src, model)));
                    }
                    return [4 /*yield*/, (0, object_1.promiseAllObj)(promises)];
                case 1:
                    files = _b.sent();
                    return [2 /*return*/, sources.map(function (src) { return files[(0, json_1.canonicalJsonString)(src)]; })];
            }
        });
    });
}
function getSourceFileFromModel(model) {
    if (model && mmcif_1.MmcifFormat.is(model.sourceData)) {
        if (model.sourceData.data.file) {
            ...
            var block = (0, cif_1.CifBlock)(Array.from(frame.categoryNames), frame.categories, frame.header);
            var file = (0, cif_1.CifFile)([block]);
            return file;
        }
    }
    else {
...
function annotationSourceFromSpec(s) {
    switch (s.source.name) {
        case 'url':
            return tslib_1.__assign({ kind: 'url' }, s.source.params);
        case 'source-cif':
