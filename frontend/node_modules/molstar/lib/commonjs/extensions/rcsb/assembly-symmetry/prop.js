...
(function (AssemblySymmetry) {
    ...
    AssemblySymmetry.DefaultServerUrl = 'https://data.rcsb.org/graphql'; // Alternative: 'https://www.ebi.ac.uk/pdbe/aggregated-api/pdb/symmetry' (if serverType is 'pdbe')
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        if (props.serverType === 'pdbe')
                            return [2 /*return*/, fetch_PDBe(ctx, structure, props)];
    ...
    function fetch_PDBe(ctx, structure, props) {
        var _a, _b;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var assembly_id, entry_id, url, asset, dataWrapper, err_1, data, value;
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        assembly_id = ((_a = structure.units[0].conformation.operator.assembly) === null || _a === void 0 ? void 0 : _a.id) || '-1';
                        entry_id = structure.units[0].model.entryId.toLowerCase();
                        url = "".concat(props.serverUrl, "/").concat(entry_id, "?assembly_id=").concat(assembly_id);
                        asset = assets_1.Asset.getUrlAsset(ctx.assetManager, url);
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, ctx.assetManager.resolve(asset, 'json').runInContext(ctx.runtime)];
                    case 2:
                        dataWrapper = _c.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        if ("".concat(err_1).includes('404')) { // dirrrty
                    ...
                    case 4:
                        ...
                        value = ((_b = data[entry_id]) !== null && _b !== void 0 ? _b : []).map(function (v) { return ({
                        ...
                        return [2 /*return*/, { value: value, assets: [dataWrapper] }];
                }
            });
        });
    }
...
})(AssemblySymmetry || (exports.AssemblySymmetry = AssemblySymmetry = {}));
...
exports.AssemblySymmetryDataParams = {
    ...
    serverUrl: param_definition_1.ParamDefinition.Text(AssemblySymmetry.DefaultServerUrl, { description: 'GraphQL endpoint URL (if server type is RCSB) or PDBe API endpoint URL (if server type is PDBe)' })
};
