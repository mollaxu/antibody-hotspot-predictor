...
exports.getRCSBAssemblySymmetryConfig = exports.RCSBAssemblySymmetryConfig = exports.tryCreateAssemblySymmetry = exports.AssemblySymmetryPreset = exports.AssemblySymmetry3D = exports.InitAssemblySymmetry3D = exports.RCSBAssemblySymmetry = void 0;
...
exports.InitAssemblySymmetry3D = mol_state_1.StateAction.build({
    ...
    params: function (a, plugin) { return getConfiguredDefaultParams(plugin); }
})(function (_a, plugin) {
    var a = _a.a, ref = _a.ref, state = _a.state, params = _a.params;
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prop_1.AssemblySymmetryDataProvider.attach(propCtx, a.data, params)];
                case 1:
                    _a.sent();
                    ...
                    return [4 /*yield*/, prop_1.AssemblySymmetryProvider.attach(propCtx, a.data, tslib_1.__assign(tslib_1.__assign({}, params), { symmetryIndex: symmetryIndex }))];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
...
exports.AssemblySymmetryPreset = (0, representation_preset_1.StructureRepresentationPresetProvider)({
    ...
    params: function (a, plugin) {
        return tslib_1.__assign(tslib_1.__assign({}, representation_preset_1.StructureRepresentationPresetProvider.CommonParams), getConfiguredDefaultParams(plugin));
    },
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, plugin.runTask(mol_task_1.Task.create('Assembly Symmetry', function (runtime) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var propCtx, propProps, assemblySymmetryData, symmetryIndex;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            propCtx = { runtime: runtime, assetManager: plugin.managers.asset };
                                            propProps = { serverType: params.serverType, serverUrl: params.serverUrl };
                                            return [4 /*yield*/, prop_1.AssemblySymmetryDataProvider.attach(propCtx, structure, propProps)];
                                        case 1:
                                            _a.sent();
                                            assemblySymmetryData = prop_1.AssemblySymmetryDataProvider.get(structure).value;
                                            symmetryIndex = assemblySymmetryData ? prop_1.AssemblySymmetry.firstNonC1(assemblySymmetryData) : -1;
                                            return [4 /*yield*/, prop_1.AssemblySymmetryProvider.attach(propCtx, structure, tslib_1.__assign(tslib_1.__assign({}, propProps), { symmetryIndex: symmetryIndex }))];
                                        case 2:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
                    ...
                    case 3:
                        ...
                        colorTheme = getRCSBAssemblySymmetryConfig(plugin).ApplyColors && assemblySymmetry.isOk ? Tag.Cluster : undefined;
...
//
exports.RCSBAssemblySymmetryConfig = {
    DefaultServerType: new config_1.PluginConfigItem('rcsb-assembly-symmetry.server-type', prop_1.AssemblySymmetryDataParams.serverType.defaultValue),
    DefaultServerUrl: new config_1.PluginConfigItem('rcsb-assembly-symmetry.server-url', prop_1.AssemblySymmetryDataParams.serverUrl.defaultValue),
    ApplyColors: new config_1.PluginConfigItem('rcsb-assembly-symmetry.apply-colors', true),
};
function getRCSBAssemblySymmetryConfig(plugin) {
    var _a, _b, _c, _d, _e, _f;
    return {
        ApplyColors: (_b = (_a = plugin.config.get(exports.RCSBAssemblySymmetryConfig.ApplyColors)) !== null && _a !== void 0 ? _a : exports.RCSBAssemblySymmetryConfig.ApplyColors.defaultValue) !== null && _b !== void 0 ? _b : true,
        DefaultServerType: (_d = (_c = plugin.config.get(exports.RCSBAssemblySymmetryConfig.DefaultServerType)) !== null && _c !== void 0 ? _c : exports.RCSBAssemblySymmetryConfig.DefaultServerType.defaultValue) !== null && _d !== void 0 ? _d : prop_1.AssemblySymmetryDataParams.serverType.defaultValue,
        DefaultServerUrl: (_f = (_e = plugin.config.get(exports.RCSBAssemblySymmetryConfig.DefaultServerUrl)) !== null && _e !== void 0 ? _e : exports.RCSBAssemblySymmetryConfig.DefaultServerUrl.defaultValue) !== null && _f !== void 0 ? _f : prop_1.AssemblySymmetryDataParams.serverUrl.defaultValue,
    };
}
exports.getRCSBAssemblySymmetryConfig = getRCSBAssemblySymmetryConfig;
function getConfiguredDefaultParams(plugin) {
    var config = getRCSBAssemblySymmetryConfig(plugin);
    var params = param_definition_1.ParamDefinition.clone(prop_1.AssemblySymmetryDataParams);
