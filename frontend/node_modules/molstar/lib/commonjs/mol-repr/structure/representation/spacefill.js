...
var SpacefillVisuals = {
    'element-sphere': function (ctx, getParams) { return (0, units_representation_1.UnitsRepresentation)('Sphere mesh/impostor', ctx, getParams, element_sphere_1.ElementSphereVisual); },
    'structure-element-sphere': function (ctx, getParams) { return (0, representation_1.ComplexRepresentation)('Structure sphere mesh/impostor', ctx, getParams, element_sphere_1.StructureElementSphereVisual); },
};
exports.SpacefillParams = tslib_1.__assign(tslib_1.__assign({}, element_sphere_1.ElementSphereParams), { bumpFrequency: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 10, step: 0.1 }, base_1.BaseGeometry.ShadingCategory), visuals: param_definition_1.ParamDefinition.MultiSelect(['element-sphere'], param_definition_1.ParamDefinition.objectToOptions(SpacefillVisuals)) });
