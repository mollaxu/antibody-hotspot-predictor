...
var nucleotide_atomic_ring_fill_1 = require("../visual/nucleotide-atomic-ring-fill");
var nucleotide_atomic_bond_1 = require("../visual/nucleotide-atomic-bond");
var nucleotide_atomic_element_1 = require("../visual/nucleotide-atomic-element");
...
var CartoonVisuals = {
    ...
    'nucleotide-atomic-ring-fill': function (ctx, getParams) { return (0, units_representation_1.UnitsRepresentation)('Nucleotide atomic ring fill', ctx, getParams, nucleotide_atomic_ring_fill_1.NucleotideAtomicRingFillVisual); },
    'nucleotide-atomic-bond': function (ctx, getParams) { return (0, units_representation_1.UnitsRepresentation)('Nucleotide atomic bond', ctx, getParams, nucleotide_atomic_bond_1.NucleotideAtomicBondVisual); },
