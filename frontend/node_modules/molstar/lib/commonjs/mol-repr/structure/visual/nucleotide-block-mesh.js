...
var pt = (0, linear_algebra_1.Vec3)();
...
function createNucleotideBlockMesh(ctx, unit, structure, theme, props, mesh) {
    ...
    var sphere = geometry_1.Sphere3D.expand((0, geometry_1.Sphere3D)(), unit.boundary.sphere, radius);
