...
var element_2 = require("./util/element");
exports.LabelTextParams = tslib_1.__assign(tslib_1.__assign({}, complex_visual_1.ComplexTextParams), { background: param_definition_1.ParamDefinition.Boolean(false), backgroundMargin: param_definition_1.ParamDefinition.Numeric(0, { min: 0, max: 1, step: 0.01 }), backgroundColor: param_definition_1.ParamDefinition.Color(names_1.ColorNames.black), backgroundOpacity: param_definition_1.ParamDefinition.Numeric(0.5, { min: 0, max: 1, step: 0.01 }), borderWidth: param_definition_1.ParamDefinition.Numeric(0.25, { min: 0, max: 0.5, step: 0.01 }), level: param_definition_1.ParamDefinition.Select('residue', [['chain', 'Chain'], ['residue', 'Residue'], ['element', 'Element']], { isEssential: true }), ignoreHydrogens: param_definition_1.ParamDefinition.Boolean(false), ignoreHydrogensVariant: param_definition_1.ParamDefinition.Select('all', param_definition_1.ParamDefinition.arrayToOptions(['all', 'non-polar'])), chainScale: param_definition_1.ParamDefinition.Numeric(10, { min: 0, max: 20, step: 0.1 }), residueScale: param_definition_1.ParamDefinition.Numeric(1, { min: 0, max: 20, step: 0.1 }), elementScale: param_definition_1.ParamDefinition.Numeric(0.5, { min: 0, max: 20, step: 0.1 }) });
...
function createElementText(ctx, structure, theme, props, text) {
    ...
    for (var i = 0, il = units.length; i < il; ++i) {
        ...
        l.unit = unit;
        var groupOffset = cumulativeUnitElementCount[i];
        var ignore = (0, element_2.makeElementIgnoreTest)(structure, unit, tslib_1.__assign(tslib_1.__assign({}, props), { traceOnly: false }));
