...
function createShape(plyData, mesh, coloring, grouping) {
    ...
    return shape_1.Shape.create('ply-mesh', source, mesh, function (groupId) {
...
function makeShapeGetter() {
    ...
    var _coloring;
    var _grouping;
    var getShape = function (ctx, plyData, props, shape) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
...
function shapeFromPly(source, params) {
    ...
    return mol_task_1.Task.create('Shape Provider', function (ctx) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, {
                    label: 'Mesh',
                    data: { source: source, transforms: params === null || params === void 0 ? void 0 : params.transforms },
