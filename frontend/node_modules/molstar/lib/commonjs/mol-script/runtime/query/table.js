...
var symbols = [
    ...
    C(symbol_table_1.MolScriptSymbolTable.core.math.cantorPairing, function (ctx, v) { return (0, util_1.cantorPairing)(v[0](ctx), v[1](ctx)); }),
    C(symbol_table_1.MolScriptSymbolTable.core.math.sortedCantorPairing, function (ctx, v) { return (0, util_1.sortedCantorPairing)(v[0](ctx), v[1](ctx)); }),
    C(symbol_table_1.MolScriptSymbolTable.core.math.invertCantorPairing, function (ctx, v) { return (0, util_1.invertCantorPairing)([0, 0], v[0](ctx)); }),
    ...
    C(symbol_table_1.MolScriptSymbolTable.core.math.trunc, function (ctx, v) { return Math.trunc(v[0](ctx)); }),
    C(symbol_table_1.MolScriptSymbolTable.core.math.abs, function (ctx, v) { return Math.abs(v[0](ctx)); }),
    C(symbol_table_1.MolScriptSymbolTable.core.math.sign, function (ctx, v) { return Math.sign(v[0](ctx)); }),
