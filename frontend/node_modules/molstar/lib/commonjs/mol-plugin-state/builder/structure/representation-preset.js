...
var coarseSurface = StructureRepresentationPresetProvider({
    ...
    apply: function (ref, params, plugin) {
        var _a, _b, _c, _d;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var structureCell, components, structure, thresholds, size, gaussianProps, _e, update, builder, typeParams, symmetryColor, symmetryColorParams, representations;
            var _f;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                    ...
                    case 2:
                        components = (_f.lipid = _g.sent(),
                            _f);
                        structure = structureCell.obj.data;
                        thresholds = plugin.config.get(config_1.PluginConfig.Structure.SizeThresholds) || structure_1.Structure.DefaultSizeThresholds;
                        size = structure_1.Structure.getSize(structure, thresholds);
