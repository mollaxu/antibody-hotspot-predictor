...
var LigandEncoder = /** @class */ (function () {
    ...
    LigandEncoder.prototype.getAtoms = function (instance, source, ccdAtoms) {
    ...
    LigandEncoder.prototype._getAtoms = function (source, fields, label_atom_id, type_symbol, ccdAtoms) {
        var atoms = new Map();
        var index = 0;
