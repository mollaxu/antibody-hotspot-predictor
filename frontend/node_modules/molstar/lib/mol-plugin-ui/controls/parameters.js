...
export function ToggleParamHelpButton(_a) {
    var show = _a.show, toggle = _a.toggle, title = _a.title;
    return _jsx("button", { className: 'msp-help msp-btn-link msp-btn-icon msp-control-group-expander', onClick: toggle, title: title || "".concat(show ? 'Hide' : 'Show', " help"), style: { background: 'transparent', textAlign: 'left', padding: '0' }, children: _jsx(Icon, { svg: HelpOutlineSvg }) });
}
